...
# Bash Script to insert data from courses.csv and students.csv into students database
...
cat students.csv | while IFS="," read FIRST LAST MAJOR GPA; do
    if [[ $FIRST != "first_name" ]]; then
        ...
        # When you go to insert the student data,
        # you want to use the MAJOR_ID if it's found, or null if not
